...
#define TFT_DC   PIN_D8//#define TFT_DC   PIN_D3  // Data Command control pin
#define TFT_RST -1 //#define TFT_RST  PIN_D4  // Reset pin (could connect to NodeMCU RST, see next line)
